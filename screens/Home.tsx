      ...
      {item.price !== null && item.price !== undefined && (
        <>
          ...
          {item.oldPrice !== null && item.oldPrice !== undefined && (
            <Text style={styles.cardOriginalPrice}>₹{item.oldPrice.toFixed(2)}</Text>
          )}
  ...
  const groupedProducts = [
    {
      ...
      data: products.filter(product => product.category === 'Product of the Day'),
      horizontal: true,
    },
    {
      title: 'Browse by Health Condition',
      data: products.filter(product => product.category === 'browseByHealthCondition'),
      horizontal: false,
    },
    {
      title: 'Top Brands',
        ...
        ListHeaderComponent={
          <View style={styles.promotionSection}>
            ...
            <View style={styles.promotionCard}>
              ...
              <Text style={styles.promotionDescription}>Get 20% off on all products this week!</Text>
            </View>
          </View>
        }
        ListFooterComponent={
